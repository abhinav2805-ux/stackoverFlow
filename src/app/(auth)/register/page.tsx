...
export default function Register() {
    ...
    // whole logic of register function
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        if (response.error) {
            setError(() => response.error!.message);// forcefully extract error message
        } else {
            const loginResponse = await login(email.toString(), password.toString());
            if (loginResponse.error) {
                setError(() => loginResponse.error!.message);// forcefully extract error message
            }
        }
